...
function Sidenav({ xyz }) {
    return (
        <>
            <div className="fixed backdrop-blur lg:hidden md:hidden z-10 flex flex-col justify-between space-y-8 px-4 py-4 bxsd animate__animated animate__rotateInDownRight animate__repeat-1 h-full w-60 overflow-hidden bg-white/90">
          ...
          Famous for Khurja Ceramic Pottery – A GI-tagged cultural heritage of India.
        </p>
        <div className="mt-4">
          <a
            href="https://odopup.in/en/article/bulandshahar"
            target="_blank"
            rel="noopener noreferrer"
            className="text-emerald-400 hover:underline"
          >
            Visit Official ODOP Bulandshahr Page →
          </a>
        </div>
        <p className="mt-6 text-xs text-gray-500">
          © {new Date().getFullYear()} Shrey Kumar | Khurja Pottery
        </p>
      </div>
            </div>
        </>
