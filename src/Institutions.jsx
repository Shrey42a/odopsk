  ...
  return (
    <section className="h-max p-2 mt-2 w-full flex flex-col space-y-8 lg:space-x-4 justify-center items-center">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-10">Institutions & Sustainability</h2>
        <div className="grid md:grid-cols-3 gap-8">
          {institutions.map((inst, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg flex flex-col justify-between items-center overflow-hidden pb-2 hover:shadow-xl transition-shadow">
