            ...
            <div className='w-full min-h-screen max-h-max'>
                <div className='min-h-screen max-h-max w-full p-2 pt-4 bg-white/60 backdrop-blur-sm flex flex-col space-y-4 items-center justify-start'>
                    <div className='w-full text-lg text-center fnt5 lg:w-4/5 h-max rounded-2xl flex flex-col items-center justify-start'>
                       ...
                       <p>Hello! I m <span className="text-xl font-bold tracking-widest text-orange-600" >Shrey Kumar </span> a passionate, dedicated tech enthusiast from Ahamadanagar, Bulandshahr. Currently, I’m pursuing my Master of Computer Applications (MCA) from a reputed institution in Meerut & student of <a href='https://codeyogi.io' target='blank' className='text-xl font-bold tracking-widest text-orange-600'>CODEYOGI</a> , where I am honing my technical skills and deepening my knowledge of software development.</p>
                       <p>With one year of hands-on coding experience, I have worked extensively on various technologies, particularly focusing on JavaScript, ReactJS, MongoDB, MySQL, ExpressJs, NodeJs, SEO, UI/UX, Git/Github, Typescript, Figma and continued. I have developed and optimized applications, built interactive websites, and handled API integrations effectively. </p>
                    </div>
                    <div className='h-full fnt1 w-full lg:w-4/5 rounded-lg text-xl text-center flex flex-col items-center justify-start space-y-2'>
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-8">This React-based web application has been built as part of the{" "}
          <strong>Digital District Showcase</strong> initiative, highlighting the{" "}
          <strong>One District, One Product (ODOP)</strong> scheme for Bulandshahr district,
          Uttar Pradesh. The ODOP scheme aims to promote unique products from each district
          and provide artisans with better market opportunities, training, and resources.
        </p>
